...
nodes = [
    (40.6892, -74.0445),  # Example latitude and longitude for the first point
    (37.7749, -122.4194),  # Example latitude and longitude for the second point
    # Add more nodes as needed
]

current_angle = 45  # Example value for current_angle
previous_node = None
