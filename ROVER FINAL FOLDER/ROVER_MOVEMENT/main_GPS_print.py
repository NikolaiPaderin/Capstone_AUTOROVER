...
prev0, prev1 =  get_GPS()#30.62071, -96.33994#
...
time.sleep(3)
curr0, curr1 = get_GPS()#30.62068, -96.33996#
print("current GPS: ", curr0, curr1)
current_angle = 0
...
angle_difference = angle_from_north
...
with open('nodes.csv', mode = 'r') as csvfile:
    ...
    for row in reader:
        ...
        while(distance_meters > 0.25):
            ...
            with open('path_node_list.csv', mode = 'a', newline = '') as file:
        ...
        curr0, curr1 = get_GPS() #destination_lat, destination_lon#
